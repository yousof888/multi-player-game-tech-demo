info.player4.onScore(-1, function () {
    game.gameOver(false)
})
controller.player4.onEvent(ControllerEvent.Connected, function () {
    _4 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    controller.player4.moveSprite(_4, 0, 100)
    _4.setPosition(12, 50)
    _4.setStayInScreen(true)
...
controller.player3.onEvent(ControllerEvent.Connected, function () {
    _3 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    controller.player3.moveSprite(_3, 0, 100)
    _3.setPosition(12, 50)
...
info.player3.onScore(-1, function () {
    game.gameOver(false)
})
...
controller.player4.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    P4 = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
...
controller.player1.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    P1 = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
...
controller.player2.onEvent(ControllerEvent.Connected, function () {
    _2 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    controller.player2.moveSprite(_2, 0, 100)
    _2.setPosition(12, 50)
...
controller.player1.onEvent(ControllerEvent.Connected, function () {
    _1 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    controller.player1.moveSprite(_1, 0, 100)
    _1.setPosition(12, 50)
...
game.onUpdateInterval(5000, function () {
    Alen = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Alen, assets.tile`myTile`)
    Alen.setVelocity(randint(0, -50), 0)
})
